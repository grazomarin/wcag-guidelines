                            ...
                            <Portal>
                                <PopoverContent>
                                    <PopoverBody>
                                        <PopoverArrow />
                                        <Text>
                                            <span style={{ fontWeight: "bold" }}>Contrast Ratio</span>{" "} 
                                            is a measurement that describes the difference in luminance between two colors, 
                                            typically text and its background, to ensure readability for users. 
                                            A higher contrast ratio makes text easier to read for your users!
                                        </Text>
                                    </PopoverBody>
                                </PopoverContent>
                            </Portal>
